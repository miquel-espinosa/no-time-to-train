CONFIG=./no_time_to_train/new_exps/sam2/sam2_small.yaml
...
for SHOT in "${SHOTS[@]}"; do
        ...
        RESULTS_DIR=work_dirs/sam2_small/few_shot_results_${SHOT}shot_seed${SEED}
        mkdir -p $RESULTS_DIR
        ...
        echo -e "\033[31mSAM2 SMALL, SHOT $SHOT\033[0m"
