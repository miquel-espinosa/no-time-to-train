CONFIG=./no_time_to_train/new_exps/pe/coco_PEg14_Sam2L.yaml
...
for SHOT in "${SHOTS[@]}"; do
        ...
        RESULTS_DIR=work_dirs_a100/PEg14/few_shot_results_${SHOT}shot_seed${SEED}
        mkdir -p $RESULTS_DIR
        ...
        echo -e "\033[31mPE G14, SHOT $SHOT\033[0m"
