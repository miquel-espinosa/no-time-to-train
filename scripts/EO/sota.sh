...
DEVICES=4,5,6,7
NUM_DEVICES=4
CAT_NAMES='large-vehicle,swimming-pool,helicopter,bridge,plane,ship,soccer-ball-field,basketball-court,ground-track-field,small-vehicle,baseball-diamond,tennis-court,roundabout,storage-tank,harbor,container-crane,airport,helipad'
CATEGORY_NUM=18
SEED=42
