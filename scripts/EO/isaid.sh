...
DEVICES=4,5,6,7
NUM_DEVICES=4
CAT_NAMES='storage_tank,Large_Vehicle,Small_Vehicle,plane,ship,Swimming_pool,Harbor,tennis_court,Ground_Track_Field,Soccer_ball_field,baseball_diamond,Bridge,basketball_court,Roundabout,Helicopter'
CATEGORY_NUM=15
SEED=42
