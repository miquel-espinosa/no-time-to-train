...
DATASET_CATEGORY_NUM['RAREPLANES']=7
DATASET_CAT_NAMES['RAREPLANES']="Large-Civil-Transport/Utility,Medium-Civil-Transport/Utility,Military-Bomber,Military-Fighter/Interceptor/Attack,Military-Trainer,Military-Transport/Utility/AWAC,Small-Civil-Transport/Utility"

DATASET_CATEGORY_NUM['RAREPLANES_SINGLE_CLASS']=1
DATASET_CAT_NAMES['RAREPLANES_SINGLE_CLASS']="airplane"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "     [--heuristics] [--list-datasets] [-h|--help]"
            echo ""
            echo "Other options:"
            echo "  --list-datasets     List available datasets and exit"
            echo "  --heuristics        Use heuristics to sample the dataset"
