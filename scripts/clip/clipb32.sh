CONFIG=./no_time_to_train/new_exps/clip/coco_clipb32_Sam2L.yaml
...
for SHOT in "${SHOTS[@]}"; do
        ...
        RESULTS_DIR=work_dirs/clipb32/few_shot_results_${SHOT}shot_seed${SEED}
        mkdir -p $RESULTS_DIR
        ...
        echo -e "\033[31mCLIP B32, SHOT $SHOT\033[0m"
